...
CREATE TABLE "new_equipments" (
    ...
    "details" TEXT,
    "place_id" TEXT,
    CONSTRAINT "equipments_place_id_fkey" FOREIGN KEY ("place_id") REFERENCES "places" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "new_materials" (
    ...
    "details" TEXT,
    "place_id" TEXT,
    CONSTRAINT "materials_place_id_fkey" FOREIGN KEY ("place_id") REFERENCES "places" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
